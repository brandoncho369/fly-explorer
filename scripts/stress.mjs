...
await p.waitForFunction(() => document.body.innerText.includes("2,596"), null, { timeout: 30000 });
...
await p.waitForFunction((real) => document.body.innerText.includes(real ? "139," : "2,596"), hasReal, { timeout: 120000 });
await p.waitForTimeout(800);
