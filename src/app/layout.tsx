...
export const metadata: Metadata = {
  ...
  description: "The FlyWire Drosophila connectome (139k neurons, 3.7M synapses) running as a spiking network in your browser. Fire a sense or any cell type, see what the wiring does, and a benchmark that says whether it still behaves like a fly.",
  icons: { icon: "/icon.svg" },
